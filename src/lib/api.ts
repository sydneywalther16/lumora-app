...
export const api = {
  ...
  startSeedanceVideoReferenceCanary: (payload: { userId?: string | null; variant?: 'reference_videos_bracket' | 'reference_videos_at' | 'video_urls_at'; forceNormalize?: boolean; allowOriginalFallback?: boolean } = {}) =>
