...
export async function buildRenderPathCompareDiagnostics() {
  try {
    ...
    return {
      ...
      exactRouteActive: exactLikenessRouterChoice.route === 'kling_reference' && exactLikenessRouterChoice.exactLikeness,
      exactProvider: exactLikenessRouterChoice.exactLikeness ? exactLikenessRouterChoice.provider : null,
      sceneAnchorStrategy: null,
      lastRenderReferenceStrategy: realPath?.referenceFieldShape ?? null,
