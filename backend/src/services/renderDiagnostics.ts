...
function lastAiCastStudioDiagnostics(row: LatestRenderRow | null) {
  ...
  return {
    ...
    primaryVideoInputType: text('primaryVideoInputType'),
    primaryVideoInputSource: text('primaryVideoInputSource'),
    startFrameSource: text('startFrameSource'),
    posterFrameSource: text('posterFrameSource'),
    firstFrameSource: text('firstFrameSource'),
    stage2ProviderModel: text('stage2ProviderModel'),
    stage2ProviderRouteType: text('stage2ProviderRouteType'),
    rawReferenceVisualInputsSentToStage2: bool('rawReferenceVisualInputsSentToStage2', false),
    identityReferencesPassedToVideoStage: bool('identityReferencesPassedToVideoStage', false),
    identityReferenceMode: text('identityReferenceMode'),
